...
<!--                left empty for white space-->
            ...
            <div class="col-md-6 pb-3" id="contactForm">
                <h1 class="pt-3">CONTACT ME</h1>
                <p>Thanks for visiting! Feel free to use the contact info on this page, or simply fill out my contact form and I'll get back to you as soon as possible - usually within 48 hours.</p>
            ...
            <div class="col-md-4 pt-3">
                ...
                <p>
                        email: <a href="mailto: amandarwang001@gmail.com" class="text-white">amandarwang001@gmail.com</a>
                        <br>
                        phone: <a href="tel:8639443986" class="navbar-btn emphasisFont1 text-white">
                            (863)-944-3986</a>
                    <br>
                    location: Orlando, FL
                    </small>
