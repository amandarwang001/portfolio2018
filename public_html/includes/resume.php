        ...
        <h3 class="pt-3">Work Experience</h3>
            ...
            <div class="card lightBlueBackground navbarFont p-3 mt-3">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        <ul>
                        <li>Instruct students in Bagua Zhang and Northern Shaolin Kung Fu</li>
                        <li>Host and plan annual seminar events</li>
                        <li>Manage website and SEO</li>
                    </ul>
...
<!--                    </ul>-->
            ...
            <div class="card lightBlueBackground navbarFont p-3 mt-3">
                <div class="card-body">
                    ...
                    <p class="card-text">
                    <ul>
                        <li>Designed custom nutritional programs for weight loss based on Traditional Chinese
                            Medicine.
                        </li>
                        <li>Wrote a weekly blog educating patients on Traditional Chinese Medicine and Homeopathy.</li>
                        <li>Maintained Bookkeeping, Operations and Customer Service.</li>
                        <li>Conducted all consultations via HIPAA-compliant, encrypted online video chat.</li>
                    </ul>
                    </p>
                </div>
            </div>
            ...
            <div class="card lightBlueBackground navbarFont p-3 mt-3">
                <div class="card-body">
                    ...
                    <p class="card-text">
                    <ul>
                        <li>Consulted with Licensed Acupuncturists on difficult and medically-complex cases.</li>
                        <li>Consulted with patients on their complicated health issues.</li>
                        <li>Educated patients about Traditional Chinese Medicine/Alternative Medicine.</li>
                    </ul>
                    </p>
                </div>
            </div>
            ...
            <div class="card lightBlueBackground navbarFont p-3 mt-3 mb-5">
                <div class="card-body">
                    ...
                    <p class="card-text">
                    <ul>
                        <li>Diagnosed and treated a wide range of conditions including pain, fibromyalgia, and
                            infertility.
                        </li>
                        <li>Designed and prescribed herbal formulas based on Traditional Chinese Medicine.</li>
                        <li>Incorporated adjunct modalities such as: gua sha, cupping and moxibustion into treatments.
                        </li>
                        <li>Developed and implemented a lowered-cost Community Acupuncture program.</li>
                    </ul>
                    </p>
                </div>
            </div>
            ...
            <div class="card grayBackground navbarFont p-3 mt-3">
                <div class="card-body">
                    ...
                    <p class="card-subtitle"><small>Master of Science in Acupuncture and Oriental Medicine -- 2010<br>
                            Bachelor of Science in Professional Health Studies -- 2010</small></p>
                </div>
            </div>
